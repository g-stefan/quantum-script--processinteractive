...
#	define XYO_QUANTUMSCRIPT_EXTENSION_PROCESSINTERACTIVE_EXPORT XYO_LIBRARY_EXPORT
#else
#	define XYO_QUANTUMSCRIPT_EXTENSION_PROCESSINTERACTIVE_EXPORT XYO_LIBRARY_IMPORT
#endif
